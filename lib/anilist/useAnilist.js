...
export const useAniList = (session) => {
  ...
  `;
    ...
    if (media && media.type !== "MANGA") {
      ...
      if (!checkList?.includes("Watched using ANIMETV7")) {
        checkList.push("Watched using ANIMETV7");
      ...
      if (!lists?.includes("Watched using ANIMETV7")) {
        lists.push("Watched using ANIMETV7");
      }
