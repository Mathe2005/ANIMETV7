...
export default function DMCA() {
  return (
    <>
      <Head>
        <title>ANIMETV7 - DMCA</title>
        <meta name="DMCA" content="DMCA" />
        <meta property="og:title" content="DMCA" />
        <meta
          property="og:description"
          content="animetv7.com is committed to respecting the intellectual
          ...
          <div className="w-[75%] text-2xl gap-7 flex flex-col my-[10rem]">
            ...
            <div className="flex flex-col gap-10">
              <div className="flex flex-col gap-3 text-[#cdcdcd]">
                <p>
                  ANIMETV7 is committed to respecting the intellectual
                  property rights of others and complying with the Digital
              ...
              <p className="text-[#cdcdcd]">
                None of the files listed on ANIMETV7 are hosted on our
                servers. All links point to content hosted on third-party
                websites. ANIMETV7 does not accept responsibility for content
                ...
                <a
                  href="mailto:contact@animetv7.com?subject=[ANIMETV7]%20-%20Your%20Subject"
